    ...
    return (
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex-1">
                ...
                {/* Vision & Mission */}
                <Section className="bg-zinc-50/50 dark:bg-zinc-950/50 border-t border-zinc-100 dark:border-zinc-900">
                    <div className="grid grid-cols-1 gap-10 md:grid-cols-2 max-w-5xl mx-auto">
                        {/* Vision */}
                        <Card variant="premium" className="p-8 sm:p-10 text-center flex flex-col items-center">
                            ...
                            <p className="text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
                                ...
                                and continuously evolving to meet the dynamic needs of the workforce.
                            </p>
                        </Card>
                        ...
                        <Card variant="premium" className="p-8 sm:p-10 text-center flex flex-col items-center">
                            ...
                            <p className="text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
                                ...
                                recruitment solutions that foster mutual growth and success.
                            </p>
                        </Card>
                    </div>
                </Section>
