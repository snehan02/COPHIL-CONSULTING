    ...
    return (
        <footer className="bg-zinc-900 text-white" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 pb-8 pt-12 sm:pt-16 lg:px-8 lg:pt-20">
                <div className="grid grid-cols-1 gap-8 sm:gap-10 sm:grid-cols-2 lg:grid-cols-4 text-center sm:text-left">

                    {/* Brand Block */}
                    <div className="sm:col-span-2 lg:col-span-1 space-y-5">
                        <div className="pl-4 border-l-[3px] border-accent inline-block sm:block text-left">
                            <span className="text-3xl sm:text-4xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-accent to-white bg-[length:200%_auto] animate-[shimmer_3s_linear_infinite] leading-none block">
                                Cophil
                            </span>
                            <span className="text-xs sm:text-sm font-bold uppercase tracking-[0.3em] text-accent mt-1 block">
                                Consulting
                            </span>
                        </div>
                        ...
                        <div className="flex justify-center sm:justify-start space-x-3">
                            ...
                            <Link
                                ...
                                aria-label="LinkedIn"
                                className="flex items-center justify-center h-10 w-10 sm:h-9 sm:w-9 rounded-full border border-zinc-700 text-zinc-400 hover:border-accent hover:text-accent transition-all duration-200"
                            >
